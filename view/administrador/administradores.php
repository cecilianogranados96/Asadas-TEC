<div class="page-404 padding ptb-xs-40">
    <div class="container">
        ...
        <?php }else { ?>
                ...
                <?php 
                    $sth = mysqli_query($link,"SELECT persona.nombre,primerApellido,segundoApellido,persona.id_persona,usuario.id_asada, asada.nombre as asada , usuario.usuario, usuario.id_usuario from persona,usuario,asada WHERE persona.id_persona = usuario.id_persona and asada.id_asada = usuario.id_asada and usuario.tipo_usuario_id = 4");
                    while($r = mysqli_fetch_assoc($sth)) {
                        echo '
                         <tr>
