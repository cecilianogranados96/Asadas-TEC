    ...
    <div class="container" >
        ...
        if(isset($_GET['tramite'])){ 
            ...
            echo "<script>location.href='?pag=".$_GET['pag']."';</script>";
                ...
                $sth = mysqli_query($link,"SELECT tramite.id_tramite, tramite.nombre, tramite.descripcion, tramite.plantilla, asada.nombre as asada,tramite.estado_tramite  FROM tramite,asada WHERE asada.id_asada = tramite.id_asada  and tramite.id_asada = '".$_SESSION["asada"]."' ORDER BY id_tramite,estado_tramite ASC");
