<div class="page-404 padding ptb-xs-40">
    <div class="container">
        ...
        ?>
                <center><h1>Registrar Administrador</h1></center>
                <form method="post" action="?pag=<?php echo $_GET['pag']; ?>&nuevo=1&nuevo1=1" class="form-horizontal">       
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <select  id="select-beast" name="id_distrito" class="form-control"  required>
        ...
        ?>
                <center><h1>Editar Administrador</h1></center>
        ...
        <?php }else { ?>
                ...
                <center><a href="?pag=master/fontaneros&nuevo=1"  class="btn btn-success" href="#">Nuevo Fontanero</a></center>
                <br>
                <table class="table">
                  <tr class="success">
                ...
                <?php 
                    $sth = mysqli_query($link,"SELECT persona.nombre,primerApellido,segundoApellido,persona.id_persona,usuario.id_asada, asada.nombre as asada , usuario.usuario, usuario.id_usuario from persona,usuario,asada WHERE persona.id_persona = usuario.id_persona and asada.id_asada = usuario.id_asada and usuario.tipo_usuario_id = 2");
                    while($r = mysqli_fetch_assoc($sth)) {
                        echo '
                         <tr>
