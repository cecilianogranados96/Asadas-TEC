<div class="page-404 padding ptb-xs-40">
    <div class="container">
        ...
        if (isset($_GET['nuevo'])) {
            ...
            <form method="post"
                  action="?pag=<?php echo $_GET['pag']; ?>&tipo=<?php echo $_GET['tipo']; ?>&nuevo=1&nuevo1=1"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="telefono" type="text" placeholder="Teléfono" class="form-control input-md"
                               required/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="direccion" type="text" placeholder="Teléfono" class="form-control input-md"
                               required/>
                    </div>
                </div>
                <div class="form-group">
        ...
        <?php } elseif (isset($_GET['editar'])) {
            ...
            if (isset($_GET['editar1'])) {
                ...
                mysqli_query($link, "
                    UPDATE `usuario` SET `usuario`= '" . $_POST['usuario'] . "'," . $pass . " `id_asada`='" . $_POST['id_asada'] . "' WHERE id_usuario = '" . $_GET['editar'] . "'");
            ...
            <form method="post"
                  action="?pag=<?php echo $_GET['pag']; ?>&tipo=<?php echo $_GET['tipo']; ?>&editar=<?php echo $_GET['editar']; ?>&editar1=1"
                  class="form-horizontal">
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Nombre</label>
                    <div class="col-md-4">
                        <input name="nombre" type="text" placeholder="Nombre" value="<?php echo $datos['nombre']; ?>"
                               class="form-control input-md" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="primerApellido" type="text" placeholder="Primer apellido"
                               value="<?php echo $datos['primerApellido']; ?>" class="form-control input-md" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Segundo apellido</label>
                    <div class="col-md-4">
                        <input name="segundoApellido" type="text" placeholder="Segundo apellido"
                               value="<?php echo $datos['segundoApellido']; ?>" class="form-control input-md" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Usuario</label>
                    <div class="col-md-4">
                        <input name="usuario" type="text" placeholder="Usuario" value="<?php echo $datos['usuario']; ?>"
                               class="form-control input-md" required/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="telefono" type="text" placeholder="Teléfono"
                               value="<?php echo $datos['nombre']; ?>" class="form-control input-md" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Ubicación</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="direccion" type="text" placeholder="Dirección"
                               value="<?php echo $datos['direccion']; ?>" class="form-control input-md" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Asada</label>
        ...
        <?php } else { ?>
            <center><h1><?php if ($tipo != 0){ echo $nombre; ?></h1></center>
            <center><a href="?pag=<?php echo $_GET['pag']; ?>&tipo=<?php echo $_GET['tipo']; ?>&nuevo=1"
                       class="btn btn-success" href="#">Nuevo <?php echo $nombre;} ?></a></center>

            <center>
                <form action="?pag=<?php echo $_GET['pag']; ?>&tipo=<?php echo $_GET['tipo']; ?>"
                      class="form-horizontal" style="width: 50%;" method="post">
                    <div class="col-md-3">
                        Busqueda
                    </div>
                    <div class="col-md-7">
                        <input name="querry" type="text" placeholder="Busqueda" <?php if (isset($_POST['querry'])) {
                            echo 'value="' . $_POST['querry'] . '"';
                        } ?> class="form-control input-md"/>
                    </div>
                    <div class="col-md-2">
                        <button class="btn btn-success" type="submit">Enviar</button>
