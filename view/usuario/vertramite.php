<div class="page-404 padding ptb-xs-40">
    <div class="container">
				...
				<div class="cont-resolver-tramite">
						<h1 class="form-title" id="nombre"></h1>
						<form>
						    <div id="campos">
				  ...
				  <div class="formulario-buttons">
					<a href = "mistramites.html" class = "azul-bttn-little">Regresar</a>
					<a id="guardar" href = "#" class = "azul-bttn-little">Descargar</a>
				  </div>
				  <br>
				  <br>
				</div>
