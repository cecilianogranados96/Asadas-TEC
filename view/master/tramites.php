        ...
        <table class="table table-striped">
          <tr class="warning">
            ...
            <?php 
                ...
                $consulta = "SELECT tramite.id_tramite, tramite.nombre, tramite.descripcion, tramite.plantilla, asada.nombre as asada,tramite.estado_tramite  FROM tramite,asada WHERE asada.id_asada = tramite.id_asada  and tramite.id_asada = '".$_SESSION["asada"]."' ORDER BY id_tramite,estado_tramite ASC";
